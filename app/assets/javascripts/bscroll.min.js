...
!function (t, i) {
  ...
  function l(t) {
    ...
    var o = void 0;
    "undefined" != typeof MouseEvent ? o = new MouseEvent("click", i({
      bubbles: !0,
      cancelable: !1
    }, s)) : ((o = document.createEvent("Event")).initEvent("click", !0, !1), i(o, s)), o._constructed = !0, t.target.dispatchEvent(o)
  }

  function c(t, i) {
    i.firstChild ? p(t, i.firstChild) : i.appendChild(t)
  }
  ...
  function d(t, i, e, s, o, n) {
    var r = t - i, h = Math.abs(r) / e, a = n.deceleration, l = n.itemHeight, c = n.swipeBounceTime, p = n.wheel,
      u = n.swipeTime, d = p ? 4 : 15, m = t + h / a * (r < 0 ? -1 : 1);
    return p && l && (m = Math.round(m / l) * l), m < s ? (m = o ? s - o / d * h : s, u = c) : m > 0 && (m = o ? o / d * h : 0, u = c), {
  ...
  var y = function () {
      ...
      return Array.from(t)
    }, x = navigator.userAgent.toLowerCase(), T = /wechatdevtools/.test(x), b = x.indexOf("android") > 0,
    S = document.createElement("div").style, _ = function () {
      var t = {webkit: "webkitTransform", Moz: "MozTransform", O: "OTransform", ms: "msTransform", standard: "transform"};
      for (var i in t) if (void 0 !== S[t[i]]) return i;
      return !1
    }(), M = e("transform"), P = e("perspective") in S, X = "ontouchstart" in window || T, Y = !1 !== M,
    D = e("transition") in S, E = {
      transform: M,
    ...
    }, k = 1, W = {touchstart: k, touchmove: k, touchend: k, mousedown: 2, mousemove: 2, mouseup: 2}, H = {
      startX: 0,
      startY: 0,
      scrollX: !1,
      scrollY: !0,
    ...
    L = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || function (t) {
      return window.setTimeout(t, (t.interval || 100 / 60) / 2)
    },
    z = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || function (t) {
      window.clearTimeout(t)
    }, C = 1, A = -1, I = 1, F = -1;
  return g.prototype.handleEvent = function (t) {
    switch (t.type) {
      case"touchstart":
      case"mousedown":
        this._start(t);
    ...
    if (!i || this.visible) {
      var s = t ? 250 : 500;
      t = t ? "1" : "0", this.wrapperStyle[E.transitionDuration] = s + "ms", clearTimeout(this.fadeTimeout), this.fadeTimeout = setTimeout(function () {
    ...
    if ("vertical" === this.direction) {
      ...
      this.x = s, this.scroller.options.useTransform ? this.indicatorStyle[E.transform] = "translateX(" + s + "px)" + this.scroller.translateZ : this.indicatorStyle.left = s + "px"
    }
    ...
    i.preventDefault(), i.stopPropagation(), this.transitionTime(), this.initiated = !0, this.moved = !1, this.lastPointX = e.pageX, this.lastPointY = e.pageY, this.startTime = t(), this._handleMoveEvents(s), this.scroller.trigger("beforeScrollStart")
    ...
    if (this.initiated) {
      this.initiated = !1, t.preventDefault(), t.stopPropagation(), this._handleMoveEvents(o);
      var i = this.scroller.options.snap;
      if (i) {
        var e = i.speed, s = i.easing, n = void 0 === s ? O.bounce : s,
        ...
        this.scroller.x === r.x && this.scroller.y === r.y || (this.scroller.directionX = 0, this.scroller.directionY = 0, this.scroller.currentPage = r, this.scroller.scrollTo(r.x, r.y, h, n))
      }
    ...
    t.prototype._init = function (t, i) {
      ...
      function t() {
        if (!this.destroyed) {
          var t = (e = r(this.scroller)).width, n = e.height;
      ...
      var e = r(this.scroller), s = e.width, o = e.height;
      i.call(this)
      ...
      var i = r(this.scroller);
      this.scrollerWidth = i.width, this.scrollerHeight = i.height;
      var e = this.options.wheel;
      e ? (this.items = this.scroller.children, this.options.itemHeight = this.itemHeight = this.items.length ? this.scrollerHeight / this.items.length : 0, void 0 === this.selectedIndex && (this.selectedIndex = e.selectedIndex || 0), this.options.startY = -this.selectedIndex * this.itemHeight, this.maxScrollX = 0, this.maxScrollY = -this.itemHeight * (this.items.length - 1)) : (this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.maxScrollY = this.wrapperHeight - this.scrollerHeight), this.hasHorizontalScroll = this.options.scrollX && this.maxScrollX < 0, this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < 0, this.hasHorizontalScroll || (this.maxScrollX = 0, this.scrollerWidth = this.wrapperWidth), this.hasVerticalScroll || (this.maxScrollY = 0, this.scrollerHeight = this.wrapperHeight), this.endTime = 0, this.directionX = 0, this.directionY = 0, this.wrapperOffset = n(this.wrapper), this.trigger("refresh"), this.resetPosition()
    ...
    i.prototype._start = function (i) {
      var e = W[i.type];
      if ((e === k || 0 === i.button) && !(!this.enabled || this.destroyed || this.initiated && this.initiated !== e)) {
        this.initiated = e, this.options.preventDefault && !h(i.target, this.options.preventDefaultException) && i.preventDefault(), this.moved = !1, this.distX = 0, this.distY = 0, this.directionX = 0, this.directionY = 0, this.movingDirectionX = 0, this.movingDirectionY = 0, this.directionLocked = 0, this._transitionTime(), this.startTime = t(), this.options.wheel && (this.target = i.target), this.stop();
      ...
      if (this.enabled && !this.destroyed && W[i.type] === this.initiated) {
        this.options.preventDefault && i.preventDefault();
        var e = i.touches ? i.touches[0] : i, s = e.pageX - this.pointX, o = e.pageY - this.pointY;
        this.pointX = e.pageX, this.pointY = e.pageY, this.distX += s, this.distY += o;
        var n = Math.abs(this.distX), r = Math.abs(this.distY), h = t();
        if (!(h - this.endTime > this.options.momentumLimitTime && r < this.options.momentumLimitDistance && n < this.options.momentumLimitDistance)) {
          ...
          s = this.hasHorizontalScroll ? s : 0, o = this.hasVerticalScroll ? o : 0, this.movingDirectionX = s > 0 ? F : s < 0 ? I : 0, this.movingDirectionY = o > 0 ? A : o < 0 ? C : 0;
          var a = this.x + s, l = this.y + o;
          ...
          var c = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft,
            ...
            u = this.pointX - c, d = this.pointY - p;
      ...
      if (this.enabled && !this.destroyed && W[i.type] === this.initiated) {
        this.initiated = !1, this.options.preventDefault && !h(i.target, this.options.preventDefaultException) && i.preventDefault(), this.trigger("touchEnd", {
          x: this.x,
          y: this.y
        }), this.isInTransition = !1;
        var e = Math.round(this.x), s = Math.round(this.y), o = e - this.absStartX, n = s - this.absStartY;
        if (this.directionX = o > 0 ? F : o < 0 ? I : 0, this.directionY = n > 0 ? A : n < 0 ? C : 0, !this.options.pullDownRefresh || !this._checkPullDown()) if (this._checkClick(i)) this.trigger("scrollCancel"); else if (!this.resetPosition(this.options.bounceTime, O.bounce)) {
          this.scrollTo(e, s), this.endTime = t();
          var r = this.endTime - this.startTime, a = Math.abs(e - this.startX), l = Math.abs(s - this.startY);
          if (this._events.flick && r < this.options.flickLimitTime && a < this.options.flickLimitDistance && l < this.options.flickLimitDistance) this.trigger("flick"); else {
            var c = 0;
            if (this.options.momentum && r < this.options.momentumLimitTime && (l > this.options.momentumLimitDistance || a > this.options.momentumLimitDistance)) {
              var p = this.hasHorizontalScroll ? d(this.x, this.startX, r, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options) : {
                  destination: e,
                  duration: 0
                },
                u = this.hasVerticalScroll ? d(this.y, this.startY, r, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options) : {
                  destination: s,
                  duration: 0
                };
            ...
            if (this.options.snap) {
              var f = this._nearestSnap(e, s);
              this.currentPage = f, c = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(e - f.x), 1e3), Math.min(Math.abs(s - f.y), 1e3)), 300), e = f.x, s = f.y, this.directionX = 0, this.directionY = 0, m = this.options.snap.easing || O.bounce
            }
            if (e !== this.x || s !== this.y) return (e > 0 || e < this.maxScrollX || s > 0 || s < this.maxScrollY) && (m = O.swipeBounce), void this.scrollTo(e, s, c, m);
        ...
        if (this.options.wheel) {
          if (this.target && this.target.className === this.options.wheel.wheelWrapperClass) {
            var e = Math.abs(Math.round(this.y / this.itemHeight)),
              s = Math.round((this.pointY + n(this.target).top - this.itemHeight / 2) / this.itemHeight);
            this.target = this.items[e + s]
          }
          return this.scrollToElement(this.target, this.options.wheel.adjustTime || 400, !0, !0, O.swipe), !0
        }
        return !i && (this.options.tap && a(t, this.options.tap), this.options.click && !h(t.target, this.options.preventDefaultException) && l(t), !0)
      }
      return !1
    }, i.prototype._resize = function () {
      var t = this;
      this.enabled && (b && (this.wrapper.scrollTop = 0), clearTimeout(this.resizeTimeout), this.resizeTimeout = setTimeout(function () {
        t.refresh()
      }, this.options.resizePolling))
    }, i.prototype._startProbe = function () {
      function t() {
        var e = i.getComputedPosition();
        i.trigger("scroll", e), i.isInTransition ? i.probeTimer = L(t) : i.trigger("scrollEnd", e)
      }

      z(this.probeTimer), this.probeTimer = L(t);
      var i = this
    }, i.prototype._transitionProperty = function () {
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "transform";
      this.scrollerStyle[E.transitionProperty] = t
    }, i.prototype._transitionTime = function () {
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
      if (this.scrollerStyle[E.transitionDuration] = t + "ms", this.options.wheel) for (var i = 0; i < this.items.length; i++) this.items[i].style[E.transitionDuration] = t + "ms";
      ...
      if (this.scrollerStyle[E.transitionTimingFunction] = t, this.options.wheel) for (var i = 0; i < this.items.length; i++) this.items[i].style[E.transitionTimingFunction] = t;
      ...
      t.target === this.scroller && this.isInTransition && (this._transitionTime(), this.pulling || this.resetPosition(this.options.bounceTime, O.bounce) || (this.isInTransition = !1, 3 !== this.options.probeType && this.trigger("scrollEnd", {
        x: this.x,
        y: this.y
      })))
    }, i.prototype._translate = function (t, i) {
      if (this.options.useTransform ? this.scrollerStyle[E.transform] = "translate(" + t + "px," + i + "px)" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel) for (var e = this.options.wheel.rotate, s = void 0 === e ? 25 : e, o = 0; o < this.items.length; o++) {
        var n = s * (i / this.itemHeight + o);
        this.items[o].style[E.transform] = "rotateX(" + n + "deg)"
      }
      if (this.x = t, this.y = i, this.indicators) for (var r = 0; r < this.indicators.length; r++) this.indicators[r].updatePosition()
    }, i.prototype._animate = function (i, e, s, o) {
      function n() {
        var p = t();
        if (p >= c) return r.isAnimating = !1, r._translate(i, e), void(r.pulling || r.resetPosition(r.options.bounceTime) || r.trigger("scrollEnd", {
          x: r.x,
          y: r.y
        }));
        var u = o(p = (p - l) / s), d = (i - h) * u + h, m = (e - a) * u + a;
        r._translate(d, m), r.isAnimating && (r.animateTimer = L(n)), 3 === r.options.probeType && r.trigger("scroll", {
          x: r.x,
          y: r.y
        })
      }

      var r = this, h = this.x, a = this.y, l = t(), c = l + s;
      this.isAnimating = !0, z(this.animateTimer), n()
    }, i.prototype.scrollBy = function (t, i) {
      var e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
        s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : O.bounce;
      t = this.x + t, i = this.y + i, this.scrollTo(t, i, e, s)
    }, i.prototype.scrollTo = function (t, i) {
      var e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
        s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : O.bounce;
      this.isInTransition = this.options.useTransition && e > 0 && (t !== this.x || i !== this.y), !e || this.options.useTransition ? (this._transitionProperty(), this._transitionTimingFunction(s.style), this._transitionTime(e), this._translate(t, i), e && 3 === this.options.probeType && this._startProbe(), this.options.wheel && (i > 0 ? this.selectedIndex = 0 : i < this.maxScrollY ? this.selectedIndex = this.items.length - 1 : this.selectedIndex = Math.round(Math.abs(i / this.itemHeight)))) : this._animate(t, i, e, s.fn)
      ...
      return this.options.useTransform ? (i = +((t = t[E.transform].split(")")[0].split(", "))[12] || t[4]), e = +(t[13] || t[5])) : (i = +t.left.replace(/[^-\d.]/g, ""), e = +t.top.replace(/[^-\d.]/g, "")), {
        x: i,
        y: e
      }
    ...
    t.prototype.on = function (t, i) {
      ...
      if (i) for (var e = i.length, s = [].concat(w(i)), o = 0; o < e; o++) {
        var n = s[o], r = y(n, 2), h = r[0], a = r[1];
    ...
    t.prototype._initSnap = function () {
      ...
      if (i.loop) {
        ...
        e.length > 0 && (c(e[e.length - 1].cloneNode(!0), this.scroller), this.scroller.appendChild(e[1].cloneNode(!0)))
      }
      var s = i.el;
      "string" == typeof s && (s = this.scroller.querySelectorAll(s)), this.on("refresh", function () {
        if (t.pages = [], t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight) {
          var e = i.stepX || t.wrapperWidth, o = i.stepY || t.wrapperHeight, n = 0, h = void 0, a = void 0, l = void 0,
            c = 0, p = void 0, u = 0, d = void 0, m = void 0;
          if (s) for (p = s.length, d = -1; c < p; c++) m = r(s[c]), (0 === c || m.left <= r(s[c - 1]).left) && (u = 0, d++), t.pages[u] || (t.pages[u] = []), n = Math.max(-m.left, t.maxScrollX), h = Math.max(-m.top, t.maxScrollY), a = n - Math.round(m.width / 2), l = h - Math.round(m.height / 2), t.pages[u][d] = {
            x: n,
            y: h,
            width: m.width,
            height: m.height,
            cx: a,
            cy: l
          }, n > t.maxScrollX && u++; else for (a = Math.round(e / 2), l = Math.round(o / 2); n > -t.scrollerWidth;) {
            for (t.pages[c] = [], p = 0, h = 0; h > -t.scrollerHeight;) t.pages[c][p] = {
        ...
        i.loop && (0 === t.currentPage.pageX && t._goToPage(t.pages.length - 2, t.currentPage.pageY, 0), t.currentPage.pageX === t.pages.length - 1 && t._goToPage(1, t.currentPage.pageY, 0))
        ...
        if (i.loop) {
          ...
          e.length > 2 && (u(t.scroller, e[e.length - 1]), u(t.scroller, e[0]))
        }
      })
      ...
      var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, e = arguments[2], s = arguments[3],
        o = this.options.snap;
      if (o && this.pages && (s = s || o.easing || O.bounce, t >= this.pages.length ? t = this.pages.length - 1 : t < 0 && (t = 0), this.pages[t])) {
      ...
      return t ? t.loop ? i({}, this.currentPage, {pageX: this.currentPage.pageX - 1}) : this.currentPage : null
    }
  }(v), function (t) {
    ...
    t.prototype._initScrollbar = function () {
      ...
      this.options.scrollX && (r = {
        ...
        fade: s,
        interactive: n
      }, this._insertScrollBar(r.el), this.indicators.push(new g(this, r))), this.options.scrollY && (r = {
        el: f("vertical"),
        direction: "vertical",
        fade: s,
        interactive: n
      }, this._insertScrollBar(r.el), this.indicators.push(new g(this, r))), this.on("refresh", function () {
    ...
    t.prototype._initPullDown = function () {
      ...
      var t = this.options.pullDownRefresh, i = t.threshold, e = void 0 === i ? 90 : i, s = t.stop,
        o = void 0 === s ? 40 : s;
      return !(this.directionY !== A || this.y < e) && (this.pulling || (this.pulling = !0, this.trigger("pullingDown")), this.scrollTo(this.x, o, this.options.bounceTime, O.bounce), this.pulling)
    }, t.prototype.finishPullDown = function () {
      this.pulling = !1, this.resetPosition(this.options.bounceTime, O.bounce)
    }
  }(v), function (t) {
    t.prototype._initPullUp = function () {
      ...
      function t(i) {
        var s = this;
        this.movingDirectionY === C && i.y <= this.maxScrollY + e && (this.once("scrollEnd", function () {
          s.pullupWatching = !1
        }), this.trigger("pullingUp"), this.off("scroll", t))
      }

      this.pullupWatching = !0;
      var i = this.options.pullUpLoad.threshold, e = void 0 === i ? 0 : i;
      this.on("scroll", t)
    ...
    t.prototype._initMouseWheel = function () {
      var t = this;
      this._handleMouseWheelEvent(s), this.on("destroy", function () {
        clearTimeout(t.mouseWheelTimer), t._handleMouseWheelEvent(o)
      ...
      if (this.enabled) {
        ...
        c = this.x + Math.round(this.hasHorizontalScroll ? h : 0), p = this.y + Math.round(this.hasVerticalScroll ? a : 0), this.directionX = h > 0 ? -1 : h < 0 ? 1 : 0, this.directionY = a > 0 ? -1 : a < 0 ? 1 : 0, c > 0 ? c = 0 : c < this.maxScrollX && (c = this.maxScrollX), p > 0 ? p = 0 : p < this.maxScrollY && (p = this.maxScrollY), this.scrollTo(c, p), this.trigger("scroll", {
          x: this.x,
          y: this.y
        })
      }
